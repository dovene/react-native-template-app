...
import { StyleSheet, Share, Platform, View, Text, ActivityIndicator, ScrollView, Image, Button, TouchableOpacity } from 'react-native';
import { getFilmDetailFromApi, getImageFromApi } from '../api/moviesService';
...
// while connecting store to component if some errors are trigerred run npm upgrade react react-dom
